...
DROP FUNCTION IF EXISTS gt_elements_by_layer_with_attributes (bigint,name[],text) CASCADE;
CREATE OR REPLACE FUNCTION gt_elements_by_layer_with_attributes (layerid bigint,columns_list name[],where_clause text)
...
$BODY$
LANGUAGE plpgsql;
COMMENT ON FUNCTION gt_elements_by_layer_with_attributes (bigint,name[],text)
	IS 'TODO';


/*SELECT * FROM gt_elements_by_layer_with_attributes(5,ARRAY['AREA','PERIMETER'],'"PERIMETER" > 80000');

SELECT * FROM gt_elements_by_layer_with_attributes(1,NULL,NULL);
