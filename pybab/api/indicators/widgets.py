...
class SingleValueInput(object):
    def __init__(self, widget_type, values, *args, **kwargs):
        self.name = name
    ...
    def get_value(self, data_dict):
        ...
        value = data_dict.get(name(self.name), None)
        return value

@serializable(GenericObjectSerializer(), serialize_method_name='render')
class DoubleValueInput(object):
    def __init__(self, widget_type, suffix_one, suffix_two, values, *args, **kwargs):
        self.name = None
    ...
    def get_value(self, data_dict):
        ...
        val1 = data_dict.get(out_name(self.suffixes[1]), None)
        return val1, val2
