...
setup(
    ...
    dependency_links=["http://github.com/MPBAUnofficial/pyhive/tarball/develop#egg=pyhive",
                      "http://github.com/davidek/django-tojson/tarball/master#egg=django-tojson"]
)
